  ...
  return (
    <Container maxWidth="md" sx={{ py: 6 }}>
      ...
      <Box sx={{ mt: 3 }}>
        ...
        <Box sx={{ mt: 2 }}>
          ...
          <Typography variant="body1">
            ...
            Analytics 4 (GA4), some of this data &mdash; such as IP-derived location and device
            identifiers &mdash; may constitute personal data under applicable privacy frameworks. We have
      ...
      <Box sx={{ mt: 3 }}>
        ...
        <Box component="ul" sx={{ mt: 0.5, mb: 1 }}>
          <Typography component="li" variant="body1">
            <strong>Authentication</strong> &mdash; keeping you logged in to your account
          </Typography>
          <Typography component="li" variant="body1">
            <strong>Analytics</strong> &mdash; understanding how the site is used (via Google Analytics)
          </Typography>
        </Box>
        <Typography variant="body1" sx={{ mb: 1 }}>
