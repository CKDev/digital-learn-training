...
Devise.setup do |config|
  ...
  # config.secret_key = '88e28cfb39c6e5d5947297243fee16053c2ea69e373efcdb309a4ea02f5bbf7ac06830167100fad8ef1d6080448718d77f71400c1a795e2a032c0417d3a73b8d'

  # ==> Mailer Configuration
  # Configure the e-mail address which will be shown in Devise::Mailer,
  # note that it will be overwritten if you use your own mailer class
  # with default "from" parameter.
  config.mailer_sender = "no-reply@training.digitallearn.org"
  ...
  # config.pepper = '0b50bbb7252aa1d5501620328af34186b4e06f502874dab2dcdeb08f98350a6d82359af9aef1d4be2f495d094188d427bf7baae168e9d3c7db26b013aa0eaaea'
  ...
  puts "Detected rails env: #{Rails.env}"
  puts "Credentials: #{Rails.application.credentials}"
